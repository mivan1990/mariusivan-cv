  ...
  en: {
    ...
    experience: {
      ...
      mapItems: [
        ...
        { name: 'NUMLOCK', img: '/projects/numlock.png' },
      ],
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'An online shop for desk gear: stitched-edge deskmats and mousepads for office and gaming setups. Built on Shopify — I co-own it and run the store and its catalogue, and I built the custom deskmat page, where a customer puts together a mat of their own.',
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'Magazin online de accesorii de birou: deskmat-uri și mousepad-uri cu margini cusute, pentru setup-uri de birou și gaming. Construit pe Shopify — sunt coproprietar, mă ocup de magazin și de catalog, și am făcut pagina de deskmat personalizat, unde clientul își compune singur mousepad-ul.',
          stack: ['Shopify', 'Liquid', 'JavaScript'],
          liveUrl: 'https://numlock.ro',
          liveKind: 'site',
          badge: 'Live',
